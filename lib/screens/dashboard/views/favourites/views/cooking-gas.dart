...
class FavoriteCookingGasView extends StatelessWidget {
  const FavoriteCookingGasView({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    "${controller.favGasStations.length} stations saved",
                  ...
                  Row(
                    children: [
                      InkWell(onTap: () {
                        ...
                        controller
                            .updateStationModel(controller.favGasStations[0]);
                        controller
                            .updateStationModel(controller.favGasStations[0]);
                        controller.toggleIsfavMapViewVisible();
                        controller
                            .updateMapViewStations(controller.favGasStations);
              ...
              (controller.isLoading2)
                  ...
                  : Column(
                      children: List.generate(
                          (controller.favGasStations.length + 1), (index) {
                        if (index == controller.favGasStations.length) {
                        ...
                        Map<String, dynamic> stationDetails =
                            controller.favGasStations[index]["stationDetails"];
                                        ...
                                        Row(
                                          children: [
                                            RichText(
                                              ...
                                              overflow: TextOverflow.ellipsis,
                                              text: TextSpan(
                                                text: controller.favGasStations[
                                                                    index][
                                                                "stationDetails"]
                                                            [
                                                            "openNowDisplay"] ==
                                                    ...
                                                    : "Closed ",
                                                style: TextStyle(
                                                    color: controller.favGasStations[
                                                                        index][
                                                                    "stationDetails"]
                                                                [
                                                                "openNowDisplay"] ==
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              controller.favGasStations[index]
                                                  ...
                                                  ? const SizedBox.shrink()
                                                  : Text(
                                                      "${controller.convertRangeToMiddle(controller.favGasStations[index]["stationDetails"]["queue"])}+ people in queue",
                                                      textAlign:
                                                          TextAlign.center,
                                                      maxLines: 2,
                                                      style: const TextStyle(
                                              ...
                                              AutoSizeText.rich(
                                                ...
                                                TextSpan(
                                                    ...
                                                    children: [
                                                      TextSpan(
                                                        text: "${controller.favGasStations[index]["stationDetails"]["gasPrice"]}/KG",
                                                        style: TextStyle(
                                                            color: Theme.of(
                                                                    context)
                                                                .textTheme
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    "(${controller.favGasStations[index]["stationDetails"]["noOfReviews"]} Reviews)",
                                                    style: const TextStyle(
                                                        color:
                                                            Color(0xff009933),
                                                        fontSize: 9),
