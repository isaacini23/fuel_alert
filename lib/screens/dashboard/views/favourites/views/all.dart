...
class FavoriteAllView extends StatelessWidget {
  const FavoriteAllView({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    "${controller.allFavouriteStations.length} stations saved",
              ...
              (controller.isLoading2)
                  ...
                  : Column(
                      children: List.generate(
                          (controller.allFavouriteStations.length + 1),
                          (index) {
                        if (index == controller.allFavouriteStations.length) {
                        ...
                        Map<String, dynamic> stationDetails = controller
                            .allFavouriteStations[index]["stationDetails"];
...
"type": stationTypes[0],
                                ...
                                "index": index,
                                "listItem": controller.allFavouriteStations
                              });
                            },
                            child: Row(
                              children: [
                                        ...
                                        Row(
                                          children: [
                                            RichText(
                                              ...
                                              overflow: TextOverflow.ellipsis,
                                              text: TextSpan(
                                                text: controller.allFavouriteStations[
                                                                    index][
                                                                "stationDetails"]
                                                            [
                                                            "openNowDisplay"] ==
                                                    ...
                                                    : "Closed ",
                                                style: TextStyle(
                                                    color: controller.allFavouriteStations[
                                                                        index][
                                                                    "stationDetails"]
                                                                [
                                                                "openNowDisplay"] ==
                                          ...
                                          child: Column(
                                            children: [
                                                      ...
                                                      controller.allFavouriteStations[index]
                                                          ...
                                                          : controller.allFavouriteStations[index]
                                                              ...
                                                              : controller.allFavouriteStations[index]
                                                                  ...
                                                                  : controller.allFavouriteStations[index]["stationDetails"]
                                                                              ["pumpAccuracy"] ==
                                                                          "Poor"
                                              ...
                                              controller.allFavouriteStations[
                                                  ...
                                                  ? const SizedBox.shrink()
                                                  : Text(
                                                      "${controller.convertRangeToMiddle(controller.allFavouriteStations[index]["stationDetails"]["queue"])}+ people in queue",
                                                      textAlign:
                                                          TextAlign.center,
                                                      maxLines: 2,
                                                      style: const TextStyle(
                                                    ...
                                                    children: [
                                                      TextSpan(
                                                        text: controller.allFavouriteStations[
                                                                    ...
                                                                    "stationType"][0] ==
                                                                "GasStation"
                                                            ? "${controller.allFavouriteStations[index]["stationDetails"]["gasPrice"]}/KG"
                                                            : "$firstTypePrice/L",
                                                        style: TextStyle(
                                                            color: Theme.of(
                                                                    context)
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    "(${controller.allFavouriteStations[index]["stationDetails"]["noOfReviews"]} Reviews)",
                                                    style: const TextStyle(
                                                        color:
                                                            Color(0xff009933),
                                                        fontSize: 9),
