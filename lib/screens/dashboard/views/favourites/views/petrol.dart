...
class FavoritePetrolView extends StatelessWidget {
  const FavoritePetrolView({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    "${controller.favPetrolStations.length} stations saved",
              ...
              (controller.isLoading2)
                  ...
                  : Column(
                      children: List.generate(
                          (controller.favPetrolStations.length + 1), (index) {
                        if (index == controller.favPetrolStations.length) {
                        ...
                        Map<String, dynamic> stationDetails = controller
                            .favPetrolStations[index]["stationDetails"];
                        ...
                        return Container(
                          ...
                          child: InkWell(
                            onTap: () {
                              controller.updateStationModel(
                                  controller.favPetrolStations[index]);
                              Get.toNamed(stationDetailsScreen, arguments: {
"type": "PetrolStation",
                                "station": controller.station,
                                "index": index,
                                "listItem": controller.favPetrolStations
                              });
                            },
                            child: Row(
                              children: [
                                        ...
                                        Row(
                                          children: [
                                            RichText(
                                              ...
                                              overflow: TextOverflow.ellipsis,
                                              text: TextSpan(
                                                text: controller.favPetrolStations[
                                                                    index][
                                                                "stationDetails"]
                                                            [
                                                            "openNowDisplay"] ==
                                                    ...
                                                    : "Closed ",
                                                style: TextStyle(
                                                    color: controller.favPetrolStations[
                                                                        index][
                                                                    "stationDetails"]
                                                                [
                                                                "openNowDisplay"] ==
                                          ...
                                          child: Column(
                                            children: [
                                                      ...
                                                      controller.favPetrolStations[index]
                                                          ...
                                                          : controller.favPetrolStations[index]
                                                              ...
                                                              : controller.favPetrolStations[index]
                                                                  ...
                                                                  : controller.favPetrolStations[index]["stationDetails"]
                                                                              ["pumpAccuracy"] ==
                                                                          "Poor"
                                              ...
                                              controller.favPetrolStations[
                                                  ...
                                                  ? const SizedBox.shrink()
                                                  : Text(
                                                      "${controller.convertRangeToMiddle(controller.favPetrolStations[index]["stationDetails"]["queue"])}+ people in queue",
                                                      textAlign:
                                                          TextAlign.center,
                                                      maxLines: 2,
                                                      style: const TextStyle(
                                              ...
                                              AutoSizeText.rich(
                                                ...
                                                TextSpan(
                                                  ...
                                                  children: [
                                                    TextSpan(
                                                      text: "${controller.favPetrolStations[index]["stationDetails"]["petrolPrice"]}/L",
                                                      style: TextStyle(
                                                          color: Theme.of(
                                                                  context)
                                                              .textTheme
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    "(${controller.favPetrolStations[index]["stationDetails"]["noOfReviews"]} Reviews)",
                                                    style: const TextStyle(
                                                        color:
                                                            Color(0xff009933),
                                                        fontSize: 9),
