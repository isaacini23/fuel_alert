...
class SearchPetrolView extends StatefulWidget {
  const SearchPetrolView({super.key});

  @override
  State<SearchPetrolView> createState() => _SearchPetrolViewState();
}

class _SearchPetrolViewState extends State<SearchPetrolView> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    "${controller.searchPetrolStations.length} stations found",
                    ...
                    children: [
                      InkWell(onTap: () {
                        ...
                        controller.updateStationModel(
                            controller.searchPetrolStations[0]);
                        controller.updateStationModel(
                            controller.searchPetrolStations[0]);
                        controller.toggleIsMapVisible();
                        controller.updateMapViewStations(
                            controller.searchPetrolStations);
              ...
              (controller.isLoading)
                  ...
                  : Column(
                      children: List.generate(
                          (controller.searchPetrolStations.length + 1),
                          (index) {
                        if (index == controller.searchPetrolStations.length) {
                        ...
                        Map<String, dynamic> stationDetails = controller
                            .searchPetrolStations[index]["stationDetails"];
                          ...
                          child: InkWell(
                            onTap: () {
                              controller.addToRecentSearchList(
                                  controller.searchPetrolStations[index]);
                              controller.updateStationModel(
                                  controller.searchPetrolStations[index]);
...
"type": "PetrolStation",
                                ...
                                "index": index,
                                "listItem": controller.searchPetrolStations
                              });
                            },
                            child: Row(
                              children: [
                                        ...
                                        Row(
                                          children: [
                                            RichText(
                                              ...
                                              overflow: TextOverflow.ellipsis,
                                              text: TextSpan(
                                                text: controller.searchPetrolStations[
                                                                    index][
                                                                "stationDetails"]
                                                            [
                                                            "openNowDisplay"] ==
                                                    ...
                                                    : "Closed ",
                                                style: TextStyle(
                                                    color: controller.searchPetrolStations[
                                                                        index][
                                                                    "stationDetails"]
                                                                [
                                                                "openNowDisplay"] ==
                                          ...
                                          child: Column(
                                            children: [
                                                      ...
                                                      controller.searchPetrolStations[index]
                                                          ...
                                                          : controller.searchPetrolStations[index]
                                                              ...
                                                              : controller.searchPetrolStations[index]
                                                                  ...
                                                                  : controller.searchPetrolStations[index]["stationDetails"]
                                                                              ["pumpAccuracy"] ==
                                                                          "Poor"
                                              ...
                                              controller.searchPetrolStations[
                                                  ...
                                                  ? const SizedBox.shrink()
                                                  : Text(
                                                      "${controller.convertRangeToMiddle(controller.searchPetrolStations[index]["stationDetails"]["queue"])}+ people in queue",
                                                      textAlign: TextAlign.center,
                                                      maxLines: 2,
                                                      style: const TextStyle(
                                                          color:
                                              ...
                                              AutoSizeText.rich(
                                                ...
                                                TextSpan(
                                                    ...
                                                    children: [
                                                      TextSpan(
                                                        text: "${controller.searchPetrolStations[index]["stationDetails"]["petrolPrice"]}/L",
                                                        style: TextStyle(
                                                            color:
                                                                Theme.of(context)
                                                                    .textTheme
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    "(${controller.searchPetrolStations[index]["stationDetails"]["noOfReviews"]} Reviews)",
                                                    style: const TextStyle(
                                                        color: Color(0xff009933),
                                                        fontSize: 9),
                                                  )
