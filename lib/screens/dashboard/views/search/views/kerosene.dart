...
class SearchKeroseneView extends StatefulWidget {
  const SearchKeroseneView({super.key});

  @override
  State<SearchKeroseneView> createState() => _SearchKeroseneViewState();
}

class _SearchKeroseneViewState extends State<SearchKeroseneView> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    "${controller.searchKeroseneStations.length} stations found",
                    ...
                    children: [
                      InkWell(onTap: () {
                        ...
                        controller.updateStationModel(
                            controller.searchKeroseneStations[0]);
                        controller.updateStationModel(
                            controller.searchKeroseneStations[0]);
                        controller.toggleIsMapVisible();
                        controller.updateMapViewStations(
                            controller.searchKeroseneStations);
              ...
              (controller.isLoading)
                  ...
                  : Column(
                      children: List.generate(
                          (controller.searchKeroseneStations.length + 1),
                          (index) {
                        if (index == controller.searchKeroseneStations.length) {
                        ...
                        Map<String, dynamic> stationDetails = controller
                            .searchKeroseneStations[index]["stationDetails"];
                          ...
                          child: InkWell(
                            onTap: () {
                              controller.addToRecentSearchList(
                                  controller.searchKeroseneStations[index]);
                              controller.updateStationModel(
                                  controller.searchKeroseneStations[index]);
...
"type": "KeroseneStation",
                                ...
                                "index": index,
                                "listItem": controller.searchKeroseneStations
                              });
                            },
                            child: Row(
                              children: [
                                        ...
                                        Row(
                                          children: [
                                            RichText(
                                              ...
                                              overflow: TextOverflow.ellipsis,
                                              text: TextSpan(
                                                text: controller.searchKeroseneStations[
                                                                    index][
                                                                "stationDetails"]
                                                            [
                                                            "openNowDisplay"] ==
                                                    ...
                                                    : "Closed ",
                                                style: TextStyle(
                                                    color: controller.searchKeroseneStations[
                                                                        index][
                                                                    "stationDetails"]
                                                                [
                                                                "openNowDisplay"] ==
                                        ...
                                        child: Column(
                                          children: [
                                                    ...
                                                    controller.searchKeroseneStations[index]
                                                        ...
                                                        : controller.searchKeroseneStations[index]
                                                            ...
                                                            : controller.searchKeroseneStations[index]
                                                                ...
                                                                : controller.searchKeroseneStations[index]["stationDetails"]
                                                                            ["pumpAccuracy"] ==
                                                                        "Poor"
                                            ...
                                            controller.searchKeroseneStations[
                                                ...
                                                ? const SizedBox.shrink()
                                                : Text(
                                                    "${controller.convertRangeToMiddle(controller.searchKeroseneStations[index]["stationDetails"]["queue"])}+ people in queue",
                                                    textAlign: TextAlign.center,
                                                    maxLines: 2,
                                                    style: const TextStyle(
                                                        color:
                                            ...
                                            AutoSizeText.rich(
                                              ...
                                              TextSpan(
                                                  ...
                                                  children: [
                                                    TextSpan(
                                                      text: "${controller.searchKeroseneStations[index]["stationDetails"]["kerosene"]}/L",
                                                      style: TextStyle(
                                                          color:
                                                              Theme.of(context)
                                                                  .textTheme
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  "(${controller.searchKeroseneStations[index]["stationDetails"]["noOfReviews"]} Reviews)",
                                                  style: const TextStyle(
                                                      color: Color(0xff009933),
                                                      fontSize: 9),
                                                )
