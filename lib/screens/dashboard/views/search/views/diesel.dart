...
class SearchDieselView extends StatefulWidget {
  const SearchDieselView({super.key});

  @override
  State<SearchDieselView> createState() => _SearchDieselViewState();
}

class _SearchDieselViewState extends State<SearchDieselView> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    "${controller.searchDieselStations.length} stations found",
                    ...
                    children: [
                      InkWell(onTap: () {
                        ...
                        controller.updateStationModel(
                            controller.searchDieselStations[0]);
                        controller.updateStationModel(
                            controller.searchDieselStations[0]);
                        controller.toggleIsMapVisible();
                        controller.updateMapViewStations(
                            controller.searchDieselStations);
              ...
              (controller.isLoading)
                  ...
                  : Column(
                      children: List.generate(
                          (controller.searchDieselStations.length + 1),
                          (index) {
                        if (index == controller.searchDieselStations.length) {
                        ...
                        Map<String, dynamic> stationDetails = controller
                            .searchDieselStations[index]["stationDetails"];
                          ...
                          child: InkWell(
                            onTap: () {
                              controller.addToRecentSearchList(
                                  controller.searchDieselStations[index]);
                              controller.updateStationModel(
                                  controller.searchDieselStations[index]);
...
"type": "DieselStation",
                                ...
                                "index": index,
                                "listItem": controller.searchDieselStations
                              });
                            },
                            child: Row(
                              children: [
                                        ...
                                        Row(
                                          children: [
                                            RichText(
                                              ...
                                              overflow: TextOverflow.ellipsis,
                                              text: TextSpan(
                                                text: controller.searchDieselStations[
                                                                    index][
                                                                "stationDetails"]
                                                            [
                                                            "openNowDisplay"] ==
                                                    ...
                                                    : "Closed ",
                                                style: TextStyle(
                                                    color: controller.searchDieselStations[
                                                                        index][
                                                                    "stationDetails"]
                                                                [
                                                                "openNowDisplay"] ==
                                          ...
                                          child: Column(
                                            children: [
                                                      ...
                                                      controller.searchDieselStations[index]
                                                          ...
                                                          : controller.searchDieselStations[index]
                                                              ...
                                                              : controller.searchDieselStations[index]
                                                                  ...
                                                                  : controller.searchDieselStations[index]["stationDetails"]
                                                                              ["pumpAccuracy"] ==
                                                                          "Poor"
                                              ...
                                              controller.searchDieselStations[
                                                  ...
                                                  ? const SizedBox.shrink()
                                                  : Text(
                                                      "${controller.convertRangeToMiddle(controller.searchDieselStations[index]["stationDetails"]["queue"])}+ people in queue",
                                                      textAlign: TextAlign.center,
                                                      maxLines: 2,
                                                      style: const TextStyle(
                                                          color:
                                              ...
                                              AutoSizeText.rich(
                                                ...
                                                TextSpan(
                                                    ...
                                                    children: [
                                                      TextSpan(
                                                        text: "${controller.searchDieselStations[index]["stationDetails"]["dieselPrice"]}/L",
                                                        style: TextStyle(
                                                            color:
                                                                Theme.of(context)
                                                                    .textTheme
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    "(${controller.searchDieselStations[index]["stationDetails"]["noOfReviews"]} Reviews)",
                                                    style: const TextStyle(
                                                        color: Color(0xff009933),
                                                        fontSize: 9),
                                                  )
