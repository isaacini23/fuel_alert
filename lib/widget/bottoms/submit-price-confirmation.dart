          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    "By submitting, I agree that the price submitted is accurate",
                    style: TextStyle(
            ...
            const Text(
              "If you submit an incorrect price, you will lose all your points.",
              style: TextStyle(
            ...
            const Text(
              "If you submit an incorrect price, your account will be suspended",
              style: TextStyle(
                color: Color(0xff8C8C8C),
                fontSize: 12,
              ),
